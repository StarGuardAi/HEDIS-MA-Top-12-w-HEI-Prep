...
**RADV Audit Intelligence Platform** · M.E.A.T. validation · Agentic RAG pipeline · Google Sheets cloud persistence

[![Live](https://img.shields.io/badge/status-live-brightgreen)](https://tinyurl.com/2vj79bem) · [Demo](https://tinyurl.com/2vj79bem) · [LinkedIn](https://tinyurl.com/24523hmy) · [GitHub](https://github.com/reichert-science-intelligence)

---

## Features

- **M.E.A.T. Validator** — HCC documentation compliance engine
- **RADV Command Center** — 25-week audit deadline tracking
- **Audit Trail** — Push audit sessions to Google Sheets (cloud persistence)
- **Chart Selection AI** — Claude-powered visualization recommendations
- **Education Tracker** — Provider training workflow
- **Real-Time Validation** — Live HCC reconciliation
...
```bash
# Clone repo
git clone https://github.com/reichert-science-intelligence/AuditShield
cd AuditShield
