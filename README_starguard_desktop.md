...
**Medicare Advantage Intelligence Platform** · HEDIS analytics · Star rating forecasting · HCC risk stratification · Google Sheets cloud sync

[![Live](https://img.shields.io/badge/status-live-brightgreen)](https://rreichert-starguard-desktop.hf.space) · [Demo](https://rreichert-starguard-desktop.hf.space) · [LinkedIn](https://tinyurl.com/24523hmy) · [GitHub](https://github.com/reichert-science-intelligence)

---

## Features

- **HEDIS Gap Refresh** — Push care gaps to Google Sheets, live KPI dashboard
- **Star Rating Forecast Cache** — Cache forecast runs with FRESH/STALE lifecycle
- **ROI by Measure** — Measure-level financial impact analysis
- **Compliance Reporting** — Validation rates and gap closure tracking
- **Health Equity** — Disparity analysis and SDOH mapping
- **Agentic Outreach** — AI-powered member engagement
- **Compound Engineering** — Self-correcting HEDIS calculations
...
```bash
# Clone repo
git clone https://github.com/reichert-science-intelligence/StarGuard
cd StarGuard
