# Production Deployment Plan *(Archived for Future Reference)*
## HEDIS Star Rating Portfolio Optimizer - Full Stack Deployment

> **Note:** The current career focus is a polished demonstration environment. This document remains as a forward-looking reference in case a prospective employer wants to explore a production roadmap. The live assets in this repository use synthetic data and are optimized for showcase conversations, not immediate migration.
