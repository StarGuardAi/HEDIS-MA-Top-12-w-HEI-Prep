# HEDIS Star Rating Portfolio Optimizer - API Usage Guide

**Version:** 2.0.0  
**Base URL:** `http://localhost:8000/api/v1`  
**Authentication:** API Key (X-API-Key header)

> **Demo Context:** The API is provided for storytelling and portfolio conversations. It serves synthetic data and mirrors production concepts without connecting to real CMS systems. Use it to demonstrate architectural thinking—not to run live operations.
...
## 🛡️ Development Rules (Guardian Project Rules)

When working with the API or making updates, follow these rules:

**Sequential Execution Only**
- Test endpoints one at a time, verify each before proceeding
- Don't run multiple API operations simultaneously that modify state
- Complete testing before production deployment

**Task Sizing**
- Break API updates into 30 min - 1 hour chunks
- Test one endpoint/feature at a time
- Verify each endpoint before moving to next

**Quick vs Full Mode**
- **Quick Mode (Default):** Test with sample data first (<15 min)
- **Full Mode (Optional):** Full integration testing (>1 hour)

**Synthetic Data First**
- Use sample/test data for development
