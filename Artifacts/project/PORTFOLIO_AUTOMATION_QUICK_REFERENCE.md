# 🚀 Portfolio Automation - Quick Reference Card
...
When working on automation scripts or updates, follow these rules:

**Sequential Execution Only**
- Complete one task before starting the next
- Test each component before moving on
- Use step-by-step approach with verification

**Quick vs Full Mode**
- **Quick Mode (Default):** Generate test materials first (<5 min)
- **Full Mode (Optional):** Generate all materials for production use

**Task Sizing**
- Break large updates into 30 min - 1 hour chunks
