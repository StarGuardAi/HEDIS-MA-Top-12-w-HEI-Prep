...
if not roi_df.empty:
    ...
    st.subheader("🎯 Top 5 Measures: Multi-Dimensional Performance")
    ...
    st.info("📊 No data available for the selected date range. Please adjust filters or check data availability.")
