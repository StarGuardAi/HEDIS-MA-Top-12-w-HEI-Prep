...
if not compliance_df_scaled.empty:
    ...
    st.subheader("📈 Compliance Status by Measure")
    ...
    # Compliance Heatmap
    st.subheader("🔥 Compliance Heatmap: ROI vs Success Rate")
    ...
    st.subheader("⚠️ Non-Compliant Measures Report")
    ...
    if len(non_compliant) > 0:
        ...
        st.success("✅ All measures are compliant!")
else:
