@echo off
REM Phase 1 Chat 1: Database Setup Runner (Windows)
REM Executes the revenue calculator foundation SQL script

echo ================================================================================
echo HEDIS STAR RATING PORTFOLIO OPTIMIZER
echo Phase 1 Chat 1: Revenue at Risk Calculator Foundation
echo ================================================================================
echo.
