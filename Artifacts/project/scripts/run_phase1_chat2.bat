@echo off
REM Phase 1 Chat 2: Gap Closure Velocity Tracking Runner (Windows)
REM Executes the velocity tracking SQL script

echo ================================================================================
echo HEDIS STAR RATING PORTFOLIO OPTIMIZER
echo Phase 1 Chat 2: Gap Closure Velocity Tracking ^& Trend Analysis
echo ================================================================================
echo.
...
echo   Port: %DB_PORT%
echo.
echo NOTE: Phase 1 Chat 1 must be completed first!
echo.

REM Run the Python script
python "%~dp0run_phase1_chat2.py"

if errorlevel 1 (
    echo.
    echo ERROR: Setup failed. Check error messages above.
    echo Make sure Phase 1 Chat 1 has been completed.
    pause
    exit /b 1
) else (
    echo.
